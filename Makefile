...
bin/SpellCh-test: build/test/main.o build/test/testSC.o build/test/file_test.o build/test/dict_test.o build/src/SpellCh.o 
	gcc -Wall -g -o0 -Werror build/test/main.o build/test/testSC.o build/test/dict_test.o build/test/file_test.o   build/src/SpellCh.o build/src/file.o build/src/dict.o    -o bin/SpellCh-test
